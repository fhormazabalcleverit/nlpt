...
const Process = () => {
  ...
  return (
    <section className="bg-backblack py-20 relative overflow-hidden">
      {/* Background SVG */}
      <div className="absolute max-w-7xl mx-auto   inset-0 bg-no-repeat bg-center opacity-100 bg-[length:100%_auto] md:bg-cover" style={{ backgroundImage: `url(${import.meta.env.BASE_URL}mastra.svg)` }}></div>
