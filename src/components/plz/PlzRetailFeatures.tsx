...
const PlzRetailFeatures = () => {
    ...
    const apps = t.useCases?.case1?.applications || {};
    const retailFeatures = [
        {
            id: 'inventario',
            shortTitle: t.plzIndustry?.retail?.nav?.inventario || 'Análisis e Inventario',
        ...
        {
            id: 'recomendaciones',
            shortTitle: t.plzIndustry?.retail?.nav?.recomendaciones || 'Recomendaciones',
        ...
        {
            id: 'pricing',
            shortTitle: t.plzIndustry?.retail?.nav?.pricing || 'Optimización de Precios',
        ...
        {
            id: 'performance',
            shortTitle: t.plzIndustry?.retail?.nav?.performance || 'Performance Tiendas',
        ...
        },
        {
            ...
            shortTitle: t.plzIndustry?.retail?.nav?.customer_intelligence || 'Customer Intelligence',
