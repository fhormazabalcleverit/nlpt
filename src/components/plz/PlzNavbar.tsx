                ...
                <div className="flex justify-between items-center h-24 relative">
                    ...
                    <div className="hidden min-[1118px]:flex items-center space-x-4">
                        ...
                        <div 
                            ...
                            className="flex items-center gap-1 bg-white/5 border border-white/10 p-1 rounded-full mr-2 cursor-pointer hover:bg-white/10 transition-all duration-300 select-none"
                ...
                <div className="min-[1118px]:hidden bg-[#040809] border-b border-white/5">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <div className="flex items-center justify-center gap-2 py-4 border-t border-white/5 mt-4">
                            ...
                            <div 
                                onClick={toggleLanguage}
                                className="flex items-center gap-1 bg-white/5 border border-white/10 p-1 rounded-full cursor-pointer hover:bg-white/10 transition-all duration-300 select-none"
                            >
                                <div
