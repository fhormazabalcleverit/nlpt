...
const PrivacyPolicyPage = () => {
    ...
    return (
        <div className="min-h-screen bg-backblack flex flex-col font-sansation">
            <DynamicSEO
                title={language === 'es' ? 'Aviso de Privacidad | LLMApps by CleverIT' : 'Privacy Policy | LLMApps by CleverIT'}
                description="Aviso de privacidad y políticas de protección de datos de LLMApps."
                        ...
                        <div className="">
                            ...
                            <div className="space-y-8 text-gray-400 font-light text-lg">
                                <div className="space-y-4">
                                    <h2 className="text-2xl font-normal text-white">1. Recopilación de Información</h2>
                                    <p className="pl-4">
                                    ...
                                    <div className="pl-6 space-y-4 pt-2">
                                        <div>
                                            <h3 className="text-xl font-normal text-[#17BBCD]">1.1 Información Personal</h3>
                                        ...
                                        <div>
                                            <h3 className="text-xl font-normal text-[#B81769]">1.2 Datos de Uso y Cookies</h3>
                                ...
                                <div className="space-y-4 pt-6 mt-6 border-t border-gray-800">
                                    <h2 className="text-2xl font-normal text-white">2. Uso de la Información</h2>
                                    <p className="pl-4">
                                ...
                                <div className="space-y-4 pt-6 mt-6 border-t border-gray-800">
                                    <h2 className="text-2xl font-normal text-white">3. Compartir y Divulgación de Datos</h2>
                                    <p className="pl-4">
                                ...
                                <div className="space-y-4 pt-6 mt-6 border-t border-gray-800">
                                    <h2 className="text-2xl font-normal text-white">4. Almacenamiento y Seguridad de Datos</h2>
                                    <p className="pl-4">
                                ...
                                <div className="space-y-4 pt-6 mt-6 border-t border-gray-800">
                                    <h2 className="text-2xl font-normal text-white">5. Derechos del Usuario</h2>
                                    <p className="pl-4">
                                        Nunc auctor erat in nibh semper tristique. Suspendisse eget elit vitae purus laoreet auctor id eget enim.
                                    </p>
                                    <div className="pl-6 space-y-4 pt-2">
                                        <div>
                                            <h3 className="text-xl font-normal text-[#17BBCD]">5.1 Acceso y Portabilidad</h3>
                                            <p className="mt-2 pl-4 border-l-2 border-[#19687A]">
                                ...
                                <div className="space-y-4 pt-6 mt-6 border-t border-gray-800">
                                    <h2 className="text-2xl font-normal text-white">7. Privacidad en Menores de Edad</h2>
                                    <p className="pl-4">
                                ...
                                <div className="space-y-4 pt-6 mt-6 border-t border-gray-800">
                                    <h2 className="text-2xl font-normal text-white">8. Cambios a esta Política</h2>
                                    <p className="pl-4">
